...
may_model_plot <- plot_model(mod_5, type="std", axis.lim = c(.25, 3), axis.title = c('Incidence Rate Ratio', 'Variable'))
sept_model_plot <- plot_model(mod_5_sept, type="std", axis.lim = c(.25, 3), axis.title = c('Incidence Rate Ratio', 'Variable'))
