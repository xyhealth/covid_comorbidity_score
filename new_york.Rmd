...
mod_4 <- glm( COVID_DEATH_COUNT ~ I(risk_score/10) + male_over_65_pct + female_over_65_pct +median_income +  less_than_high_school_pct +college_pct + african_american_pct + mexican_pct + hispanic_pct + asian_pct + white_pct + at_below_poverty_pct + more_than_one_occupant_per_room_pct + no_health_insurance_pct + unemployment_pct + COVID_CASE_COUNT + offset(log(POP_DENOMINATOR)), data=risk_score_nyc, family="poisson")
summary(mod_4)
